...
import Services from '../component/core/ServicesRavindra'
import AwardsAndAchievements from '../component/core/AwardsAndAchievementsRavindra'
...
const Profile = () => {
  return (
    <div>
        ...
        description="Profile - Astrologer Ankit Sharma ji"
      />
     <AstrologyCounseling
        title="Profile - Astrologer Ankit Sharma Ji"
        description="Highly erudite, well-seasoned, and veteran astrologer Ankit Sharma is regarded as one of the best and most credible astrologers in the whole world at present. This one of the top and leading astrologers and vashikaran experts of India holds the great credit for having helped, served, and prospered the troubled and suffering people of the world over for over two decades.
