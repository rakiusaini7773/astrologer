...
const AstrologyServices = () => {
  ...
  return (
    <div className="bg-blue-500 text-white py-12 px-6 lg:px-24" style={{
      ...
      <h1 className="text-3xl font-bold text-center mb-6">Astrology, Healing and Vashikaran Services by Astrologer Ankit Sharma Ji</h1>
      <p className="text-lg text-center mb-8">
        Today, the <strong>astrology, healing and vashikaran services by astrologer Ankit Sharma Ji</strong> are hugely popular in many cities around the world, offering quick and high efficacy solutions. These services are globally credible and come with no harmful side effects.
      </p>
