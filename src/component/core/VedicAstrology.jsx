...
const VedicAstrology = () => {
  ...
  return (
    <div className="bg-white text-gray-700 p-6 text-xl mt-8">
      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row justify-between items-start space-y-10 lg:space-y-0 lg:space-x-10">
        ...
        <div className="flex-1">
          ...
          <p className="text-xl mb-8">
            The Vedic astrology services of this <strong>world famous astrologer</strong> are based on the Vedic birth chart or numerology. Then, performed scrupulously is a comprehensive and critical analysis of all relevant facts and factors, to determine the most effective solution. Lastly, the solution is implemented by fewer very elegant and cost-effective curative measures. On the other hand, the vashikaran services of this a hugely reliable and <strong>best vashikaran specialist in the world</strong>, require a photograph of the target person, along with his/her name.
          </p>
            ...
            <div className="flex-1 flex flex-col space-y-4 lg:space-y-6 lg:order-last lg:ml-10">
              <ul className="list-none space-y-4">
                <li className="border-t border-b border-red-700 py-2">
                  <span className="text-lg">Are You Suffering from Love Problems?</span>
                </li>
                <li className="border-b border-red-700 py-2">
                  <span className="text-lg">Are You Facing Marriage Related Issues?</span>
                </li>
                <li className="border-b border-red-700 py-2">
                  <span className="text-lg">Are You Getting Sick of Family Problems?</span>
                </li>
                <li className="border-b border-red-700 py-2">
                  <span className="text-lg">Are You Facing Love Inter-caste Marriage?</span>
                </li>
                <li className="border-b border-red-700 py-2">
                  <span className="text-lg">Are You Struggling with Business Problems?</span>
                </li>
              </ul>
              <p className="text-lg mt-4 text-center lg:text-left">
                Ask 1 Question Free at <strong>+91-98154-18307</strong> Now!
              </p>
            </div>
      ...
      <div className="mt-8">
        <p className="text-lg">
        For numerous years, the exceptional offerings of this <strong>Top-rated astrologer specializing in vashikaran</strong> of the world, are also available online. These brisk online astrology and vashikaran services are very convenient to people located in remote regions. Again, counted among India's top astrologers, our grand guru ji has also invented two miraculous yantras, to offer faster results, or extra benefits. Lastly, lavish success of his top-notch services for love and love marriages, has rendered him a top love marriage specialist in India and abroad.
        </p>
