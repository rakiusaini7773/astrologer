      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center py-4 px-6">
        ...
        <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4">
          ...
          <div className="text-center sm:text-left">
            <h1 className="text-lg sm:text-2xl font-bold">Astrologer Ankit Sharma</h1>
        ...
        <div className="mt-4 md:mt-0 hidden md:flex flex-col text-center md:text-right">
          ...
          <a href="mailto:info@AstrologerAnkitSharma.com" className="text-xs sm:text-sm text-white">
