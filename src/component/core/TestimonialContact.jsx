    ...
    <div className="flex flex-col md:flex-row justify-between items-start p-6 bg-gray-100">
      ...
      <div className="md:w-1/2 w-full p-4">
        ...
        <div className="mt-4 flex items-start">
          {/* Testimonial Image */}
          <img
            src="https://www.astrologerankitsharma.com/clients-images/meenu-singh.jpg"
            alt="Client"
          ...
          <div>
            ...
            <p className="mt-2 text-gray-700">
              ...
              the great love problem solution by Ankit Ji and I noticed swift
              improvement in my life. Today I am happy and my love life is
              joyous. I am so grateful for Ankit Ji's services and his guidance
