    ...
    <div className="bg-gradient-to-b from-cyan-600 to-teal-400 py-10 px-4 md:px-8 lg:px-16">
      <div className="max-w-screen-xl mx-auto">
        <h2 className="text-3xl font-bold text-center text-white mb-8">
          Astrologer Ankit Sharma's Declarations about His Astrology Services
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="text-white space-y-6">
            <p>
              ...
              punctiliously, Astrologer Ankit Sharma has attained an enviably
            ...
            <p>
              ...
              India and abroad believe that astrologer Ankit Sharma can solve
            ...
            <p>
              ...
              think that, astrologer Ankit Sharma would conjure away their
          ...
          <div className="  p-8 text-gray-900">
            <blockquote className="text-xl italic font-semibold ">
              ...
              <cite className="block mt-4 text-right">- Astrologer Ankit Sharma</cite>
            </blockquote>
          </div>
        </div>
