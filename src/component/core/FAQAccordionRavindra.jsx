  ...
  const faqs = [
    {
      ...
      answer: (
        <>
          Pt. Ankit Sharma Ji is considered the best Indian astrology counsellor because he has been offering relieving astrology services efficiently for more than two decades. He offers solutions for numerous life issues including:
    ...
    {
      question: "Why choose services of Pt. Ankit Sharma Ji?",
      answer: (
        <>
    ...
    },
    {
      ...
      answer: "You can contact Pt. Ankit Sharma Ji via his official website, phone number, or email for consultations and appointments.",
    },
    {
      question: "What are the client reviews for the services offered by Pt. Ankit Sharma Ji?",
      answer: "Pt. Ankit Sharma Ji has received positive reviews from clients all over the world, praising his effective solutions and accurate predictions.",
    },
  ];
