    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6  bg-opacity-80 p-6 rounded-md">
        ...
        <div className="p-4 rounded-md  w-auto">
          ...
          <div className="border-t-4 border-red-500 bg-yellow-50 p-4 text-center rounded-md h-80">
            <h3 className="text-red-700 text-xl font-semibold mb-2">GET IMMEDIATE SOLUTION</h3>
            <p className="text-gray-600 mb-4">Quit Sadness, Catch Happiness!</p>
            <button className="bg-red-700 text-white py-2 px-4 rounded hover:bg-red-800 transition">
              Contact Now
            </button>
          </div>
        </div>
